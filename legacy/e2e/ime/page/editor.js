...
window.__getReport = () => {
  ...
  const stuck =
    R.comps.filter((c) => c.end - c.start > 3000).length +
    (openComp && openComp.age > 3000 ? 1 : 0);
  return {
    ...R,
    firstCompositionStart: R.firstCompositionStart ?? null,
    focusLatencyMs:
      R.firstFocus !== null && R.firstPointerDown !== null
        ? R.firstFocus - R.firstPointerDown
        : null,
    openComp,
